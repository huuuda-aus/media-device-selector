...
// Mock devices
const mockDevices = [
  { deviceId: 'mic1', kind: 'audioinput', label: 'Microphone 1', groupId: 'mic1-group' },
  { deviceId: 'mic2', kind: 'audioinput', label: 'Microphone 2', groupId: 'mic2-group' },
  { deviceId: 'cam1', kind: 'videoinput', label: 'Camera 1', groupId: 'cam1-group' },
  { deviceId: 'speaker1', kind: 'audiooutput', label: 'Speaker 1', groupId: 'speaker1-group' },
];
